...
/*
example:
import {convert} from "https://cdn.jsdelivr.net/gh/telemok/com.telemok@master/js/tbr.convert.mjs"
let a = convert.hexToUint8Array("ABCD");
*/

import {tbr} from "https://cdn.jsdelivr.net/gh/telemok/com.telemok@master/js/tbr.assert.js"
export {tbr};
tbr.convert = {};
